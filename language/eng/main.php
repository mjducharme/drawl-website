<?php
	$langar = array(
		...
		"RecorderInstructions" => "You can see the recording tool on the right-hand side. The top Recording window shows the level of the incoming sound. The bottom Recording window will show the recorded waveform when it is complete. Underneath the two windows are a Playback Control, a Microphone icon, and a Submit icon. To record yourself, click on the Microphone icon (which will glow red), read the passage aloud, and then click on the Microphone icon again to stop recording. The lower window will then show your recording as a waveform. Clicking on the Play button in the Playback Control will allow you to hear your recording.
			<ol>
			...
			<li>Click the 'Reading Passage' tab and start recording by clicking the microphone button once again. When it glows red, you can start reading out loud. When you are done, click on the microphone button to stop recording, and submit your recording. Then click on the 'Spontaneous speech prompts' tab for instructions about the second recording. </li>
			</ol> We try to be accessible through as many platforms and browsers as possible. If your browser is not supported you may get an error message when opening the recorder page. Please try with another browser/device if one is available to you.<br><br>We are interested in your natural speech. If you stumble over a word, you do not need to restart your recording. Simply repeat the sentence like you would in normal conversation. Please read at a pace you find comfortable. There is no need to rehearse before the recording.",
		"RecorderReadingTitle" => "Reading Sample: The Benefits of Hiking",
		"RecorderSpontaneous" => "Spontaneous Speech Prompts",
		"RecorderList" => "<p>Make sure you have sumbitted your recording of the Recording Passage. Click the microphone button once again and start talking out loud. When you are done, click on the microphone button to stop recording, and click the submit button again. <br><br>You can use the following prompt if you wish, or talk about something else if you'd like. You are free to decide what you discuss, but we would like to ask you to avoid topics that may be sensitive or controversial from a religious / political / racial / sexual point of view. We would also like you to avoid disclosing personally identifying information such as your name, address, workplace, etc.</p>
	        <ul>
	    	...
	    	<p>Once you have spoken for 5-8 minutes, please end your recording, and submit it using the submit button. It is now safe to close this window.</p>",
