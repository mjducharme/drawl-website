        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <br/><br/>
                <a href="{{ route('admin_users.index') }}">Go to User Management page</a>
                </div>
            </div>
            @endif
